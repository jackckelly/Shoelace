...
investigative_ability(cthulhu_mythos,"Cthulhu Mythos","You have begun to piece together the secret rules of the real world, rather than the ignorant scrim of physics and religion. You recognize the great names, and the truths they conceal. Have you read a Mythos tome, a rare, ancient book laying out in obscure detail the maddening secrets of Cthulhu and the Old Ones? This ability lets you recall any specific hints or facts from it relevant to your current situation. You can: \n- identify inhuman creatures and their spoor \n- translate pre-human tongues \n- read inscriptions of the far-distant past \n- predict what comes next when watching cult- ists perform an obscene rite \n- identify which alien god has incarnated itself inside the formless monster that is currently crushing the life out of you \n- distinguish a practitioner of an ordinary, ineffectual human occult tradition from a sorcerer able to call on the power of the Old Ones. Setbacks while using this ability may leave you with Mythos Shock Problem cards.",academic).
investigative_ability(evidence_collection,"Evidence Collection","You're adept at casing an investigation site and at finding important clues. You can: \n- spot hidden objects or objects of interest (such as bullet casings under a couch, or drops of blue ooze behind a desk) at a crime scene or other investigation site \n- note relationships between objects at a crime scene, reconstructing sequences of events \n- find, transfer, take, and compare fingerprints \n- match typewritten materials to a given machine \n- match handwriting to a known sample \n- store objects for forensic analysis without contaminating your samples",technical).
investigative_ability(flattery,"Flattery","You get people to help you by complimenting or playing up to them, as subtly or blatantly as they prefer. You can get them to: \n- reveal information \n- perform minor favors \n- regard you as trustworthy \n- date you (if applicable)",interpersonal).
investigative_ability(forensics,"Forensics","You study crime scenes and perform autopsies on deceased subjects to determine their cause and circumstances of death. You can use skeletal evidence to reconstruct the physical details (age, sex, medical condition, sometimes occupation) of the deceased. In the case of death by foul play, your examination can identify: \n- the nature of the weapon or weapons used \n- the approximate time of death \n- the presence of intoxicants or other foreign substances in the bloodstream or on the skin \n- the contents of the victim's last meal In many cases, you can reconstruct the sequence of events leading to the victim's death from the arrangement of wounds on the body. Though forensic science really only takes off in the postwar era, you can still lift and match fingerprints, make casts of tire tracks, and perform basic ballistics tests.",technical).
investigative_ability(geology,"Geology","As an expert on rocks, soils, minerals, and the primordial history of the Earth, you can: \n- analyze soil samples, crystals, minerals, and so forth \n- determine the age of a rock stratum \n- date and identify fossils \n- evaluate soil for agriculture or industry \n- identify promising sites for oil or water wells, mines, etc. \n- anticipate vulcanism, seismic events, avalanches, and other earth phenomena",academic).
investigative_ability(history,"History","A broad study of recorded human history, with an emphasis on political, military, economic, and technological developments, allows you to: \n- recognize obscure historical allusions \n- recall important or relevant events in a given country, city, or region \n- identify ancient languages and scripts (assuming they're of human origin) \n- perform textual analysis on a manuscript or book to date it or identify the author \n- determine the age of a document \n- tell where and when an object made during historical times was fashioned \n- identify the period of an article of dress or costume \n- (if based in L.A.) name Hollywood productions set in a particular historical period, supplemented with a list of their ludicrous inaccuracies",academic).
investigative_ability(inspiration,"Inspiration","You can convince reluctant witnesses to supply information by appealing to their better selves. After a few moments of interaction, you intuitively sense the positive values they hold dearest, then invoke them in a brief but stirring speech. Depend- ing on the person you're dealing with, you might call to mind their: \n- religious beliefs \n- love of friends, family, or community \n- sense of fairness \n- desire for justice \n- belief in a secular ideology, whether it be democracy, Marxism, or pacifism \n- pride in personal achievement",interpersonal).
investigative_ability(intimidation,"Intimidation","You get what you want from people by scaring them - physically, or with vividly detailed threats. You can: \n- gain information \n- inspire the subject to leave the area \n- quell a subject's desire to attempt violence against you or others \n- extract promises of future cooperation, secured by the threat of your later retaliation",interpersonal).
...
investigative_ability(law,"Law","You are familiar with the criminal and civil laws that pertain in your noir city, as well as on the state and federal levels. You can bluff your way through dealings with foreign legal systems. With this knowledge you can: \n- assess the legal risks attendant on any course of action \n- understand lawyerly jargon \n- call on legal colleagues or contacts for favors and advice \n- convincingly dispute the legality of actions undertaken by police and prosecutors",academic).
...
investigative_ability(outdoorsman,"Outdoorsman","Long hours of camping and exploration in the wild have made it as comfortable to you as life in the concrete jungle. You can: \n- tell when an animal is behaving strangely \n- tell whether an animal or plant is natural to a given area \n- find edible plants, hunt, and fish \n- make fire and survive outdoors at night or in bad weather \n- navigate overland, albeit more easily with a compass and a map \n- track people, animals, or vehicles across grass or through forests \n- hunt with dogs, including tracking with bloodhounds, assuming you have friendly dogs available Despite the period gender specificity of the term, nothing stops female characters from having this ability.",technical).
investigative_ability(pharmacy,"Pharmacy","You are able to identify and compound drugs and medicines. You can: \n- identify drugs and potions, and recognize their side-effects and contraindications \n- identify poisons and determine antidotes \n- secure or manufacture morphine, cocaine, and other controlled substances",technical).
investigative_ability(photography,"Photography","You're proficient in the use of cameras, including still and motion-picture photography. You can: \n- take useful visual records of crime scenes or expeditions \n- develop film or plates and enhance hidden details \n- use filters and lights to capture images only vis- ible in infrared or ultraviolet \n- spot manual retouching or camera trickery in a photographic image or negative \n- take trick photographs using double exposures and other methods \n- realistically retouch and manipulate photographic images \n- (Los Angeles) put cinematographers at ease by talking shop with them about the latest equipment \n- (Los Angeles) look at a movie or professionally taken still photo and identify the studio employee who lensed it",technical).
investigative_ability(physics,"Physics","You study the fundamental forces of the universe: pressure, electromagnetism, motion, gravity, op- tics, and radioactivity. You can: \n- design or refit experimental machinery to test, detect, or manipulate physical forces and energies \n- obtain and operate expensive or obscure pieces of laboratory equipment such as Crookes tubes, Geiger counters, or magnetometers \n- understand and apply advanced mathematics, including non-Euclidean geometries \n- (perhaps) understand advanced or alien technologies",academic).
investigative_ability(psychology,"Psychology","Your familiarity with the latest in the burgeoning field of human psychology grants you insight into the criminal mind. Based solely on their known modus operandi, you can make accurate guesses as to the upbringing and pathology of unidentified criminals. You can: \n- predict their upcoming actions based on their past behavior \n- distinguish an individual whose violence is deemed acceptable by his home culture from one who consciously defies cultural norms \n- distinguish subjects who can be successfully rehabilitated from the incorrigibly violent or deviant \n- tell whether a known individual's criminal behavior is in response to deep psychological impulses, or is driven primarily by greed",interpersonal).
investigative_ability(reassurance,"Reassurance","You can get people to do what you want by putting them at ease. This may involve fast talk, genuine sympathy, a rational accounting of risks, or just a calming presence. You can: \n- elicit information and minor favors \n- allay fear or panic in others \n- instill a sense of calm during a crisis \n- gain trust \n- present yourself as someone who successfully follows through on promises",interpersonal).
...
general_ability(athletics, "Athletics", "Athletics allows you to: \n- perform general acts of physical derring-do, from running to jumping to throwing bundles of dynamite to dodging oncoming objects \n- resist the effects of disease, poisoning, and intoxicants \n- resist the effects of exposure, such as hypothermia, frostbite, and sunstroke Any big physical action not covered by another ability probably goes here.", physical).
